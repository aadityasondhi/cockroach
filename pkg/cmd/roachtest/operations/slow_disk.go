...
type cleanupSlowDisk struct {
	nodes   option.NodeListOption
	staller roachtestutil.DiskStaller
}

func (cl *cleanupSlowDisk) Cleanup(ctx context.Context, o operation.Operation, c cluster.Cluster) {
...
func registerSlowDisk(r registry.Registry) {
	r.AddOperation(registry.OperationSpec{
		Name:               "slow-disk/dmsetup",
